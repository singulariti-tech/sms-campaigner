...
public class IncomingCall {
    ...
    public IncomingCallPk createPk() {
        return new IncomingCallPk(incomingCallId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (gatewayId == null ? that.gatewayId != null : !gatewayId.equals(that.gatewayId)) {
            return false;
        }
        ...
        if (callerNo != null ? !callerNo.equals(that.callerNo) : that.callerNo != null) {
            return false;
        }
