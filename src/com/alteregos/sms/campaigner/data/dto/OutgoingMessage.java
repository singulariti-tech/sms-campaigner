...
public class OutgoingMessage {
    ...
    public boolean equals (Object o) {
        ...
        if (flashMessage != that.flashMessage) return false;
        if (outgoingMessageId != that.outgoingMessageId) return false;
        if (srcPort != that.srcPort) return false;
        if (statusReport != that.statusReport) return false;
        ...
        if (recepientNo != null ? !recepientNo.equals (that.recepientNo) : that.recepientNo != null) return false;
        if (referenceNo != null ? !referenceNo.equals (that.referenceNo) : that.referenceNo != null) return false;
        if (senderNo != null ? !senderNo.equals (that.senderNo) : that.senderNo != null) return false;
