...
public class ATHandler_Ubinetics_GDC201 extends ATHandler {
     ...
     * @return returns the result from {@link org.smslib.modem.AModemDriver#isOk()}
     */
    public boolean setMemoryLocation(String mem) throws TimeoutException, GatewayException, IOException, InterruptedException {
        /*
