...
public class Settings {
    ...
    Settings() {
        if (System.getProperty("smslib.debug") != null) {
            DEBUG = true;
        }
        ...
        if (System.getProperty("smslib.serial.pollinginterval") != null) {
            SERIAL_POLLING_INTERVAL = Integer.parseInt(System.getProperty("smslib.serial.pollinginterval"));
        }
        if (System.getProperty("smslib.serial.timeout") != null) {
            SERIAL_TIMEOUT = Integer.parseInt(System.getProperty("smslib.serial.timeout"));
        }
        if (System.getProperty("smslib.serial.keepalive") != null) {
            SERIAL_KEEPALIVE_INTERVAL = Integer.parseInt(System.getProperty("smslib.serial.keepalive"));
        }
        if (System.getProperty("smslib.serial.buffer") != null) {
            SERIAL_BUFFER_SIZE = Integer.parseInt(System.getProperty("smslib.serial.buffer"));
        }
        if (System.getProperty("smslib.serial.clearwait") != null) {
            SERIAL_CLEAR_WAIT = Integer.parseInt(System.getProperty("smslib.serial.clearwait"));
        }
        if (System.getProperty("smslib.queue.interval") != null) {
            QUEUE_INTERVAL = Integer.parseInt(System.getProperty("smslib.queue.interval"));
        }
        if (System.getProperty("smslib.queue.retries") != null) {
            QUEUE_RETRIES = Integer.parseInt(System.getProperty("smslib.queue.retries"));
        }
        if (System.getProperty("smslib.outbound.retries") != null) {
            OUTBOUND_RETRIES = Integer.parseInt(System.getProperty("smslib.outbound.retries"));
        }
        if (System.getProperty("smslib.outbound.retrywait") != null) {
            OUTBOUND_RETRY_WAIT = Integer.parseInt(System.getProperty("smslib.outbound.retrywait"));
        }
        if (System.getProperty("smslib.at.wait") != null) {
            AT_WAIT = Integer.parseInt(System.getProperty("smslib.at.wait"));
        }
        if (System.getProperty("smslib.at.resetwait") != null) {
            AT_WAIT_AFTER_RESET = Integer.parseInt(System.getProperty("smslib.at.resetwait"));
        }
        if (System.getProperty("smslib.at.cmdwait") != null) {
            AT_WAIT_CMD = Integer.parseInt(System.getProperty("smslib.at.cmdwait"));
        }
        if (System.getProperty("smslib.at.cmgswait") != null) {
            AT_WAIT_CGMS = Integer.parseInt(System.getProperty("smslib.at.cmgswait"));
        }
        if (System.getProperty("smslib.at.networkwait") != null) {
            AT_WAIT_NETWORK = Integer.parseInt(System.getProperty("smslib.at.networkwait"));
        }
        if (System.getProperty("smslib.at.simpinwait") != null) {
            AT_WAIT_SIMPIN = Integer.parseInt(System.getProperty("smslib.at.simpinwait"));
        }
        if (System.getProperty("smslib.at.cnmiwait") != null) {
            AT_WAIT_CNMI = Integer.parseInt(System.getProperty("smslib.at.cnmiwait"));
        }
        if (System.getProperty("smslib.watchdog") != null) {
            WATCHDOG_INTERVAL = Integer.parseInt(System.getProperty("smslib.watchdog"));
        }
